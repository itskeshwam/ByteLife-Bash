...
bg = pygame.image.load("Venn-Games-main/Venn-Games-main/Tetris/assets/images/bg.png").convert()
game_bg = pygame.image.load("Venn-Games-main/Venn-Games-main/Tetris/assets/images/bg2.png").convert()
...
background_music = pygame.mixer.Sound("Venn-Games-main/Venn-Games-main/Tetris/assets/sounds/bg.wav")
...
def main_menu():
    ...
    background = pygame.image.load("Venn-Games-main/Venn-Games-main/Tetris/assets/images/bg2.png")
